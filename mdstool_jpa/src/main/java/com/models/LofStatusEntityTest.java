...
@Entity
@Table(name = "lof_status", schema = "rdr", catalog = "")
public class LofStatusEntityTest {
    ...
    @Basic
    @Column(name = "domain_value", nullable = true, length = -1)
    ...
    public boolean equals(Object o) {
        ...
        LofStatusEntityTest that = (LofStatusEntityTest) o;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (domainValue != null ? domainValue.hashCode() : 0);
