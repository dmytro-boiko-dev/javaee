...
public class MusicStyles {
    //playing music from URL. The file placed on my home server
    public void playMusic()  {
        System.out.println("\u001B[5;35mПрослушайте короткий микс музыкальных стилей:\u001B[0m");
        SourceDataLine clipSDL = null;
        AudioInputStream ais = null;
        byte[] b = new byte[2048];
        try {
            URL url = new URL("https://yarikzv.duckdns.org/local/audio/music.wav");
