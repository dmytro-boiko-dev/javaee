...
public class Snake {
    ...
    public void move() {
        ...
        if (snakeY[0] > SnakeFXMain.HEIGHT - 1) snakeY[0] = 0;
        if (snakeY[0] < 0) snakeY[0] = SnakeFXMain.HEIGHT - 1;

        if (snakeX[0] > SnakeFXMain.WIDTH - 1) snakeX[0] = 0;
        if (snakeX[0] < 0) snakeX[0] = SnakeFXMain.WIDTH - 1;
